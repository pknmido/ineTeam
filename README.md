...
A modern, cross-platform mobile application for matchmaking. Built using the Flutter SDK and Firebase.
...
* Firebase CLI ```bash npm install -g firebase-tools```
...
flutter pub get
```
## 3.Configure the Cloud Functions Backend
```bash
cd functions
npm install
cd ..
